...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minimumTokenBalanceForDividends = 5000000 * (10**9); // user must hold 5,000,000 token
...
contract PICKLE is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "MR. PICKLE NFT";
    string constant _symbol = "PICKLE";
    ...
    constructor () {
        ...
        marketing = 0x226E008c0F444Eec55109f3B95fb66B71d70B5fc;
